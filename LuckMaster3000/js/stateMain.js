...
var StateMain = {
    ...
    startSpin() {
        ...
        var s1 = game.rnd.integerInRange(2, 6);
        var s2 = game.rnd.integerInRange(2, 6);
        var s3 = game.rnd.integerInRange(2, 6);
		
		if(s1 == s2 && s2 == s3)
		{
			switch(s1)
			{
				case 1: win = 2; break; //2bar
				case 2: win = 5; break; //bell
				case 3: win = 3; break; //3bar
				case 4: win = 5; break; //cherry
				case 5: win = 10; break; // 7
				case 6: win = 1; break; //1bar
			}
		}
		...
		this.spinTimer = game.time.events.loop(Phaser.Timer.SECOND / 33.3333, this.spin, this);
    },
    ...
    //has left by 2
    spin: function() {
        this.barGroup.forEach(function(bar) {
            if (bar.active == true) {
